    ...
    <section className='max-padd-container py-28 xl:py-32'>
      <form onSubmit={placeOrder} action="" className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
        <div className='flex flex-col gap-3 text-[95%]'>
          ...
          <input required onChange={onChangeHandler} name='email' value={data.email} type="email" placeholder='Email' className='ring-1 ring-slate-900/15 p-1 pl-3 rounded-sm outline-none' />
