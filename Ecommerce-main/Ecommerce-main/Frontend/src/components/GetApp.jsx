...
const GetApp = () => {
    return (
        <section className='flexCenter w-full flex-col' id='app'>
            <div className='mx-auto max-w-[1440px] relative flex w-full flex-col justify-between gap-32 overflow-hidden px-6 py12 sm:flex-row sm:gap-12 sm:py-24 lg:px-20 xl:max-h-[598px] 2xl:rounded-5xl bg-primary'>
                <div className='flex w-full flex-1 flex-col items-start justify-center gap-4 xl:max-w-[555px]'>
                    <h2 className='bold-40 lg:bold-64'>GetYour app now!</h2>
                    <h4 className='uppercase medium-16 text-secondary'>Available for iOs and Android</h4>
                    <p className='py-4'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quasi porro quos ab consectetur mollitia. Magnam assumenda nisi accusantium cupiditate excepturi.</p>
