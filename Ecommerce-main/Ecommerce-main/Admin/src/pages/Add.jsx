    ...
    return (
        <section className='p-4 sm:p-10 w-full bg-primary/20'>
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-y-5 max-w-[555px]'>
                ...
                <div className='flex flex-col gap-y-2 max-w-24 h-2/4'>
                    <p>Upload image</p>
                    <label htmlFor="image">
                ...
                <div className='flex flex-col gap-y-2'>
                    ...
                    <textarea onChange={onChangeHandler} value={data.description} name="description" id="" rows={'6'} placeholder='Write content here..' required className='ring-1 ring-slate-900/10 py-1 px-3 outline-none resize-none'></textarea>
                </div>
